...
class Audio {
  ...
  public:
    ...
    uint16_t         getVUlevel();
    uint8_t          getSpectrum(uint8_t* bands, uint8_t maxBands);
    void             setSpectrumProfile(uint8_t profile);
    uint8_t          getSpectrumProfile() const { return m_fft_items.profile; }
