...
Arduino_DataBus *bus = new Arduino_ESP32SPI(TFT_DC, TFT_CS, TFT_SCLK, TFT_MOSI);
  ...
  Arduino_GFX *gfx = new Arduino_ST7796(bus, TFT_RST, tftRotation);
  ...
  Arduino_GFX *gfx = new Arduino_ST7735(bus, TFT_RST, tftRotation, false, 160, 128, 0, 0, 0, 0);

#elif defined(DISPLAY_ST7789)
  Arduino_GFX *gfx = new Arduino_ST7789(bus, TFT_RST, tftRotation, true);

#elif defined(DISPLAY_ST7789_172)
  Arduino_GFX *gfx = new Arduino_ST7789(bus, TFT_RST, tftRotation, true, 172, 320, 34, 0, 34, 0);

#elif defined(DISPLAY_ST7789_76)
  Arduino_GFX *gfx = new Arduino_ST7789(bus, TFT_RST, tftRotation, false, 76, 284, 82, 18, 82, 0); // false надо
