...
inline String getNeedlesSection() {
  ...
  html += "        <div class='setting-item support-links-card'><h3>Project</h3><div class='support-link-row'><a class='support-link-btn' href='https://github.com/Yurij75/S3-Go-radio' target='_blank' rel='noopener noreferrer'>github</a><a class='support-link-btn support-donate-btn' href='https://donatello.to/Yurij75?g=na-rozvitok-proektu' target='_blank' rel='noopener noreferrer'>на кофе</a></div></div>";
  html += "      </div>";
  html += "    </div>";
