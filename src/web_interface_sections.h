...
inline String getPlayerSection() {
  ...
  html += "              <div class='eq-slider-row'><span>Balance <strong id='eqBalanceVal'>0</strong></span>" + buildNumberStepper("eqBalance", 0, -16, 16, 1, "updateEqSliderLabel('Balance', this.value, 'eqBalanceVal'); scheduleEqUpdate()") + "</div>";
  html += "              <div class='eq-slider-row'><span>ВЧ <strong id='eqTrebleVal'>0</strong></span>" + buildNumberStepper("eqTreble", 0, -12, 12, 1, "updateEqSliderLabel('ВЧ', this.value, 'eqTrebleVal'); scheduleEqUpdate()") + "</div>";
  html += "              <div class='eq-slider-row'><span>СЧ <strong id='eqMidVal'>0</strong></span>" + buildNumberStepper("eqMid", 0, -12, 12, 1, "updateEqSliderLabel('СЧ', this.value, 'eqMidVal'); scheduleEqUpdate()") + "</div>";
  html += "              <div class='eq-slider-row'><span>НЧ <strong id='eqBassVal'>0</strong></span>" + buildNumberStepper("eqBass", 0, -12, 12, 1, "updateEqSliderLabel('НЧ', this.value, 'eqBassVal'); scheduleEqUpdate()") + "</div>";
  html += "            </div>";
  html += "          </div>";
  html += "        </div>";
  html += "      </div>";
...
inline String getUploadSection() {
  return String()
    ...
    + "            <h3>Upload files</h3>"
    + "            <input type='file' id='uploadFiles' accept='.jpg,.jpeg,.png,.csv,.json,.tar' multiple>"
