...
String getScreenPrefix(ScreenId id) {
  switch (id) {
    ...
    case ScreenId::Fft: return "fft";
    case ScreenId::StationInfo: return "s1";
    case ScreenId::FlacInfo: return "f1";
    default: return "xx";
  }
}
...
void loadCurrentScreenSettings() {
  ...
  stationNameX = nonNegativeCoord(getScreenIntDefault(prefs, id, "stationX", DISPLAY_PROFILE_STATION_X));
  stationNameY = nonNegativeCoord(getScreenIntDefault(prefs, id, "stationY", DISPLAY_PROFILE_STATION_Y));
  streamTitle1X = nonNegativeCoord(getScreenIntDefault(prefs, id, "title1X", DISPLAY_PROFILE_TITLE1_X));
  streamTitle1Y = nonNegativeCoord(getScreenIntDefault(prefs, id, "title1Y", DISPLAY_PROFILE_TITLE1_Y));
  streamTitle2X = nonNegativeCoord(getScreenIntDefault(prefs, id, "title2X", DISPLAY_PROFILE_TITLE2_X));
  streamTitle2Y = nonNegativeCoord(getScreenIntDefault(prefs, id, "title2Y", DISPLAY_PROFILE_TITLE2_Y));
  ...
  bitrateX = nonNegativeCoord(getScreenIntDefault(prefs, id, "bitrateX", DISPLAY_PROFILE_BITRATE_X));
  bitrateY = nonNegativeCoord(getScreenIntDefault(prefs, id, "bitrateY", DISPLAY_PROFILE_BITRATE_Y));
  clockX = nonNegativeCoord(getScreenIntDefault(prefs, id, "clockX", DISPLAY_PROFILE_CLOCK_X));
  clockY = nonNegativeCoord(getScreenIntDefault(prefs, id, "clockY", DISPLAY_PROFILE_CLOCK_Y));
  clockSpriteX = clockX;
  clockSpriteY = clockY;
  volumeX = nonNegativeCoord(getScreenIntDefault(prefs, id, "volumeX", DISPLAY_PROFILE_VOLUME_X));
  volumeY = nonNegativeCoord(getScreenIntDefault(prefs, id, "volumeY", DISPLAY_PROFILE_VOLUME_Y));
  ipX = nonNegativeCoord(getScreenIntDefault(prefs, id, "ipX", DISPLAY_PROFILE_IP_X));
  ipY = nonNegativeCoord(getScreenIntDefault(prefs, id, "ipY", DISPLAY_PROFILE_IP_Y));
