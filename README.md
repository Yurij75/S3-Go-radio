...
- 6 рабочих екранов (часы цифровые, часы стрелочные, стрелочный стерео вуметр, кардио вуметр, 32 полосный визуализатор, чистый дисплей для сложных flac)
...
-  управление 5 кнопок, энкодер ( 1 или 2), пульт 5 кнопок (настройка в веб еще тестируется)
...
-  темная/светлая тема
-  заставка пишет слова из файла screensaver.txt (написвть свои и загрузить в веб)
...
Можно прописать данные своей сети в конфиг:
#define DEFAULT_WIFI_SSID     "имя"        // Замените на имя вашей WiFi сети
#define DEFAULT_WIFI_PASSWORD "пароль"  // Замените на пароль вашей WiFi сети
Прошить код.
...
Первый запуск покажет черный дисплей и часы. Плейлисты и фото, или готовые темы созданные ранее или другими загрузить через веб.
Сохранить тему - нажать в веб "Export package", сформируется файл-архив с картинками и файлом с координатами.
Этот файл и есть файл темы которым можно делиться.
...
Приват - https://www.privat24.ua/send/4aby2
